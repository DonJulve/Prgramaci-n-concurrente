...
# Date:   octubre 2020
# Coms:   script de comprobación de entrega de la práctica 1 de PSCD (20/21)
#         Funcionamiento: 
#          1) Dar permisos de ejecución al script: "chmod u+x pract_1_entrega_correcta.bash"
#          2) Ejecutar mediante
#                  ./pract_1_entrega_correcta.bash NIP1_NIP2
#             en el directorio donde esté el fichero "practica_1_NIP1_NIP2.zip"
